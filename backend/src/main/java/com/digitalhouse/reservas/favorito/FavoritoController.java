...
public class FavoritoController {
    ...
    public List<ProductoResponse> listar(@AuthenticationPrincipal Long usuarioId) {
        return favoritoService.listarFavoritosConResponse(usuarioId);
    }
    ...
    @GetMapping("/check")
    public Map<String, Boolean> check(@AuthenticationPrincipal Long usuarioId, @RequestParam Long productoId) {
